...
// Spreadcoin message start
static unsigned char pchMessageStartSpreadcoin[4] = { 0x4f, 0x3c, 0x5c, 0xbb };
...
void GetMessageStart(unsigned char pchMessageStart[], bool)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, pchMessageStartSpreadcoin, sizeof(pchMessageStartSpreadcoin));
}
